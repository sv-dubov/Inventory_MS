...
<div id="app"> {{--add with Vue--}}
    <div id="wrapper">
            ...
            <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseBootstrap5" class="collapse" aria-labelledby="headingBootstrap"
                         data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <router-link to="given-salary" class="collapse-item">Given salary</router-link>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <span>copyright &copy; <script type="application/javascript"> document.write(new Date().getFullYear()); </script> - developed by
